...
```
.deer-flow-2/threads/{thread_id}/user-data/uploads/document.pdf
```
...
file_path = Path("backend/.deer-flow-2/threads/abc123/user-data/uploads/document.pdf")
...
async function uploadAndProcess(threadId: string, file: File) {
  ...
  // {
  //   filename: "report.pdf",
  //   path: ".deer-flow-2/threads/abc123/user-data/uploads/report.pdf",
  //   virtual_path: "/mnt/user-data/uploads/report.pdf",
  //   artifact_url: "/api/threads/abc123/artifacts/mnt/user-data/uploads/report.pdf",
  //   markdown_file: "report.md",
  //   markdown_path: ".deer-flow-2/threads/abc123/user-data/uploads/report.md",
...
| 场景 | 使用的路径类型 | 示例 |
|------|---------------|------|
| 服务器后端代码直接访问 | `path` | `.deer-flow-2/threads/abc123/user-data/uploads/file.pdf` |
...
| 备份脚本 | `path` | `.deer-flow-2/threads/abc123/user-data/uploads/file.pdf` |
| 日志记录 | `path` | `.deer-flow-2/threads/abc123/user-data/uploads/file.pdf` |
