...
from deerflow.rag import MetadataCondition, Resource
from deerflow.tools.retriever import get_retriever_tool
...
def get_available_tools(
    ...
    rag_resources: list[Resource] | None = None,
    ...
    if retriever_tool is not None:
        builtin_tools.append(retriever_tool)
        logger.info("Including RAG_retrieval for selected RAG resources")
