...
export const zhCN: Translations = {
  ...
  inputBox: {
    ...
    placeholderWithRag: "今天我能为你做些什么？\n可以通过附件菜单添加本地文件或 RAG 数据集。",
    ragHint: "输入 @名称 或 @{标签} 引用数据集；发送时会自动转为链接。",
    createSkillPrompt:
      "我们一起用 skill-creator 技能来创建一个技能吧。先问问我希望这个技能能做什么。",
    addAttachments: "添加附件",
    uploadSourceLabel: "上传",
    uploadSourceDescription: "从本地设备添加文件",
    ragSourceLabel: "RAG",
    ragSourceDescription: "选择现有数据集并配置元数据",
    ragDialogTitle: "添加 RAG 数据集",
    ragDialogDescription: "选择本次消息要使用的数据集，并可进一步配置元数据筛选。",
    ragSelectTab: "选择数据集",
    ragMetadataTab: "元数据",
    ragSearchPlaceholder: "搜索数据集...",
    ragSearchEmpty: "没有匹配的数据集。",
    ragSelectedDatasets: "已选数据集",
    ragConfigureMetadata: "配置元数据",
    ragUseSelection: "使用所选数据集",
    ragNoMetadataDescription: "请至少选择一个数据集后再配置元数据筛选。",
    mode: "模式",
    flashMode: "闪速",
  ...
  settings: {
    ...
    agentRuntime: {
      title: "Agent 运行时",
      description: "选择后端如何执行 Agent 工作流。",
      engineTitle: "工作流引擎",
      engineDescription:
        "LangGraph 为默认多智能体图；报告编排器适用于长文档类报告流程。",
      langgraphLabel: "LangGraph",
      langgraphHint: "默认多智能体与工具链路。",
      orchestratorLabel: "报告编排器",
      orchestratorHint: "面向结构化报告生成。",
    },
    appearance: {
      themeTitle: "主题",
