...
from deerflow.agents.middlewares.runtime_thread import resolve_thread_id
...
class ThreadDataMiddleware(AgentMiddleware[ThreadDataMiddlewareState]):
    ...
    - backend/.deer-flow-2/threads/{thread_id}/user-data/workspace
    - backend/.deer-flow-2/threads/{thread_id}/user-data/uploads
    - backend/.deer-flow-2/threads/{thread_id}/user-data/outputs
    ...
    def before_agent(self, state: ThreadDataMiddlewareState, runtime: Runtime) -> dict | None:
        ...
        if thread_id is None:
            # Some LangGraph paths (wait/replay) omit thread_id; do not hard-fail the run.
            update: dict[str, object] = {"thread_data": None}
