  ...
  "files": [
    {
      ...
      "size": 1234567,
      "path": ".deer-flow-2/threads/{thread_id}/user-data/uploads/document.pdf",
      "virtual_path": "/mnt/user-data/uploads/document.pdf",
      "artifact_url": "/api/threads/{thread_id}/artifacts/mnt/user-data/uploads/document.pdf",
      "markdown_file": "document.md",
      "markdown_path": ".deer-flow-2/threads/{thread_id}/user-data/uploads/document.md",
...
- 实际存储：`backend/.deer-flow-2/threads/{thread_id}/user-data/uploads/document.pdf`
