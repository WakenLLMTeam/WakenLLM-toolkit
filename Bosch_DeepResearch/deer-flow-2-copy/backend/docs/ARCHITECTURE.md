...
|-------------|---------------|
| `/mnt/user-data/workspace` | `backend/.deer-flow-2/threads/{thread_id}/user-data/workspace` |
| `/mnt/user-data/uploads` | `backend/.deer-flow-2/threads/{thread_id}/user-data/uploads` |
| `/mnt/user-data/outputs` | `backend/.deer-flow-2/threads/{thread_id}/user-data/outputs` |
| `/mnt/skills` | `deer-flow-2/skills/` |
...
2. Gateway receives file
   - Validates file
   - Stores in .deer-flow-2/threads/{thread_id}/user-data/uploads/
...
3. Returns response
   {
     "files": [{
       "filename": "doc.pdf",
       "path": ".deer-flow-2/.../uploads/doc.pdf",
